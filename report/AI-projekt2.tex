%
% File AI-projekt2.tex
%
% Contact: jonas.colmsjo@gizur.com
%%
%% Based on the style files for COLING-2014
...
% Enable swedish characters and language support
\usepackage[T1]{fontenc}
\usepackage{lmodern}
\usepackage[utf8]{inputenc}
\usepackage[swedish]{babel}

% Use for listing execution results
\usepackage{lscape}
\usepackage{courier}
\usepackage{listings}
...
Dorigo~\shortcite{Dorigo_1992} vilket är en avhandling skriven på Italienska.
Det finns ett antal äldre studier kring myrors beteende men Dorigo var först
med att ta fram en algoritm som baseras på deras beteende ~\cite{aco_wikipedia}. Min implementering bygger på artikeln Dorigo et. al~\shortcite{Dorigo_1996}.

\section{Dorigos algoritm}

Här följer en summering av Dorigos algoritm. Se Dorigo et. al~\shortcite{Dorigo_1996} för en mer utförlig beskrivning. Avståndet $d_{ij}$ mellan två koordinater $(x_i,y_i)$ och $(x_j, y_j)$ ges av  
